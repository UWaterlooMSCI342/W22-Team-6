...
class TeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show team" do
    save_feedback(5,4,3, 'test', @user, Time.zone.now, @team, 2)
  ...
  def test_should_destroy_team_with_feedback
    ...
    feedback = save_feedback(10,3,4, "This team is disorganized", @user, DateTime.civil_from_format(:local, 2021, 3, 1), @team, 2)
    feedback2 = save_feedback(5,5,3, "This team is disorganized", @user, DateTime.civil_from_format(:local, 2021, 3, 3), @team, 2)
    feedback3 = save_feedback(5,4,3, "This team is disorganized", user2, DateTime.civil_from_format(:local, 2021, 3, 3), team2, 2)
