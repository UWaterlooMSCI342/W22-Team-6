...
class ViewPreviousWeekTeamSummariesTest < ApplicationSystemTestCase
  ...
  def test_professor_view_previous_week_data_team_summary
    ...
    feedback1 = save_feedback(3,3,3, "User1 Week 6 Data", @user, DateTime.civil_from_format(:local, 2021, 2, 8), @team, 0)
    feedback2 = save_feedback(4,4,4, "User1 Week 6 Data", @user2, DateTime.civil_from_format(:local, 2021, 2, 9), @team2, 1)
